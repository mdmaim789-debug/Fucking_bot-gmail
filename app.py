...
# Flask for webhook (Render.com)
from flask import Flask, request

# ==========================================
# CONFIGURATION - Environment Variables
# ==========================================
# Render.com এ environment variables থেকে নিবে
API_TOKEN = os.getenv('API_TOKEN', '8492580532:AAF-h9q-344C3dYuV15cVzsaVF_WUWU4DZo')

# Parse ADMIN_IDS from environment
admin_ids_str = os.getenv('ADMIN_IDS', '[6375918223, 6337650436]')
try:
...
def webhook():
    ...
    if request.headers.get('content-type') == 'application/json':
        ...
        update = types.Update(**json.loads(json_string))
...
# ==========================================
# Render-এ data ফোল্ডার ব্যবহার করব
def get_db_path():
    # Render-এর জন্য data ফোল্ডারে ডাটাবেস রাখি
...
# ==========================================
# USER HANDLERS (সব হ্যান্ডলার একই আছে)
# ==========================================
...
if __name__ == '__main__':
    ...
    print(f"🌐 Render Mode: {'YES' if RENDER else 'NO'}")
    print("="*50)
